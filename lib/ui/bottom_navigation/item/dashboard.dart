                      ...
                      if (dropdownValue == 'Bulan Ini')
                        GridView.count(
                          ...
                          children: [
                            ...
                            card_analytic(const Color(0xFFEE6C4D), "Rating", "4.5"),
                            card_analytic(const Color(0xFF219EBC), "Produk Terjual", "100"),
                            card_analytic(const Color(0xFFF77F00), "Komplain", "0"),
                            card_analytic(const Color(0xFF354F52), "Ulasan Customer", "4.5"),
                          ],
                        )
                        ...
                        GridView.count(
                          ...
                          children: [
                            ...
                            card_analytic(const Color(0xFFEE6C4D), "Rating", "4.5"),
                            card_analytic(const Color(0xFF219EBC), "Produk Terjual", "180"),
                            card_analytic(const Color(0xFFF77F00), "Komplain", "2"),
                            card_analytic(const Color(0xFF354F52), "Ulasan Customer", "4.2"),
                          ],
                        )
                          ...
                          GridView.count(
                            ...
                            children: [
                              ...
                              card_analytic(const Color(0xFFEE6C4D), "Rating", "4.5"),
                              card_analytic(const Color(0xFF219EBC), "Produk Terjual", "340"),
                              card_analytic(const Color(0xFFF77F00), "Komplain", "5"),
                              card_analytic(const Color(0xFF354F52), "Ulasan Customer", "4.8"),
                            ],
                          )
                            ...
                            GridView.count(
                              ...
                              children: [
                                ...
                                card_analytic(const Color(0xFFEE6C4D), "Rating", "4.5"),
                                card_analytic(const Color(0xFF219EBC), "Produk Terjual", "460"),
                                card_analytic(const Color(0xFFF77F00), "Komplain", "1"),
                                card_analytic(const Color(0xFF354F52), "Ulasan Customer", "4.6"),
                              ],
                            )
                              ...
                              GridView.count(
                                ...
                                children: [
                                  ...
                                  card_analytic(const Color(0xFFEE6C4D), "Rating", "4.5"),
                                  card_analytic(const Color(0xFF219EBC), "Produk Terjual", "890"),
                                  card_analytic(const Color(0xFFF77F00), "Komplain", "1"),
                                  card_analytic(const Color(0xFF354F52), "Ulasan Customer", "4.8"),
                                ],
                              )
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            TextButton(
                              onPressed: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => const DetailPemasukanPage()));
                              },
                              child: Text(
                                "Selengkapnya",
                                style: textTheme.bodyText1!.copyWith(
                              ...
                              children: [
                                Stack(
                                  children: [
                                    ElevatedButton(
                                      onPressed: (){
                                        Navigator.push(context, MaterialPageRoute(builder: (context) => const IklanPage(
                                          selectedCategories: [],
                                        )));
                                      },
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            const SizedBox(height: 5,),
                                            Text("Iklan", style: textTheme.bodyText1!.copyWith(
                                                fontWeight: FontWeight.w700,
                                                fontSize: 14,
                                                color: Colors.white
                                            ),),
                                    ...
                                    ElevatedButton(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          const SizedBox(height: 5,),
                                          Text("Promo", style: textTheme.bodyText1!.copyWith(
                                              fontWeight: FontWeight.w700,
                                              fontSize: 14,
                                              color: Colors.white
                                          ),),
