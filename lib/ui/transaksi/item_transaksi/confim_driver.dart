...
class _ConfirmDriverState extends State<ConfirmDriver> {
  ...
  Widget buildLoadedLayout(ConfirmDriverPageLoaded state){
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  image: NetworkImage(
                                      "https://kangsayur.nitipaja.online/${state.confirmDriverModel.data[index].statusReadyDelivered[index2].variantImg}"),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
                            ...
                            Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Text(
                                    state.confirmDriverModel.data[index].statusReadyDelivered[index2].namaProduk,
                                    style: textTheme.headline6!.copyWith(
                                      color: ColorValue.neutralColor,
                                      fontSize: 19,
                                      fontWeight: FontWeight.w700,
                                ...
                                Container(
                                  width: MediaQuery.of(context).size.width * 0.5,
                                  child: Text(
                                    state.confirmDriverModel.data[index].statusReadyDelivered[index2].notes ?? "Tidak ada catatan",
                                ...
                                Row(
                                  children: [
                                    Container(
                                      ...
                                      child: Text(
                                        state.confirmDriverModel.data[index].statusReadyDelivered[index2].status,
                                        style: Theme.of(context).textTheme.subtitle1!.copyWith(
                                          fontWeight: FontWeight.w500,
                                          fontSize: 10,
    ...
    ) : notFound(context, "assets/json/menunggudriver.json", "Belum ada pesanan yang dapat dikonfirmasi oleh driver saat ini");
  }
