...
import 'package:kangsayur_seller/bloc/bloc/start_converatation_bloc.dart';
import 'package:kangsayur_seller/bloc/state/start_converatation_state.dart';
...
import '../../bloc/event/start_converatation_event.dart';
...
class _SellerCarePageState extends State<SellerCarePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => StartConvertationPageBloc(startConvertationPageRepository: StartConvertationRepository(), listChatSellerPageRepository: ListChatSellerRepository())..add(PostStartConversation(userId: '4')),
      child: BlocBuilder<StartConvertationPageBloc, StartConversationState>(
        builder: (context, state) {
          if(state is StartConversationSuccess) {
            final startConversationModel = state.startConversationModel;
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            child: ElevatedButton(
                                              onPressed: () {
                                                BlocProvider.of<StartConvertationPageBloc>(context).add(PostStartConversation(
                                                  userId: '4',
                                                ));
                                                Navigator.push(
                                                  context,
                                                  MaterialPageRoute(
                                                    builder: (context) => DetailChatSellerPage(
                                                      data: startConversationModel,
                                                    ),
                                                  ),
                                                );
                                              },
